 ...
 * ordering to shapes. The compareTo() in Shape orders shapes in descending
 * order (comparing area then perimeter). When a sorting function uses this
 * class instead of the compareTo() method in shape, the sorting function will
 * sort the list of shapes in ascending order of area.
 * 
...
{
    /**
     * Implementation of Comparator<Shape>'s compare method. This method should
     * define an ordering of shapes that would sort shapes in a descending order,
     * comparing first area and then perimeter. Look to the documentation in Shape's
     * compareTo to better understand how this should work.
     * 
    ...
    public int compare(Shape s1, Shape s2)
    {
        // TODO: implement this.
        int out = -5;
        // Check if the areas are equal, greater, or less than.
    ...
    {
        // TODO: implement this.
        // Check if the shapes == each other.
