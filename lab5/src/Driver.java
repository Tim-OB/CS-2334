 ...
 * Lab 5
 * 
 * Read lines from the user's keyboard. For each line, attempt to interpret it
 * as a Calculator Command and print out the result (or an error message).
 * 
...
public class Driver
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        while (true)
        {
            System.out.println("Enter a command: increment, decrement, add, subtract, divide...");
