 ...
 * 
 * @author CS2334. Modified by: Stephen, Tim O'Brien
 * @version 2018-11-29
 */
    ...
    public CalculatorFrame(String title) {
        ...
        slider.addChangeListener(new ChangeListener() {
        	public void stateChanged(ChangeEvent e) {
        	    ...
        	    //Get the value of the slider to a String
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
            	try {
                     ...
                     */
            	    //Int values of first and second boxes
            	    int x = Integer.parseInt(firstBox.getText());
                    int y = Integer.parseInt(secondBox.getText());
            	    ...
            	    if (add.isSelected())
            	    {
            	        ...
            	        String result = String.format("%d", z);
            	    ...
            	    if (equality.isSelected())
                    {
                        ...
                        String result = String.format("%b", z);
